"""Submit the classifier sweep to SLURM (GPU) via submit_parallel_jobs.
    ...
    python -m ops_model.interpretability.diffae.classifier.submit --gene HSPA5 --models B C
    ...
    # specific classes
    python -m ops_model.interpretability.diffae.classifier.submit --grain complex \
