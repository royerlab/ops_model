...
from ops_model.models.interpretability.diffae.traversal.precompute import build_manifest, precompute_marker, precompute_target
...
def cmd_phase_morpho(args):
    ...
    from ops_model.models.interpretability.diffae.traversal.morpho_pipeline import build_morpho_target, MORPHO_TARGETS
