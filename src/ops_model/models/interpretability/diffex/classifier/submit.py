"""Submit the classifier sweep to SLURM (GPU) via submit_parallel_jobs.
    ...
    python -m ops_model.models.interpretability.diffex.classifier.submit --gene HSPA5 --models B C

    # all 98 EBI complexes, model C
    python -m ops_model.models.interpretability.diffex.classifier.submit --grain complex --all-classes --models C

    # specific classes
    python -m ops_model.models.interpretability.diffex.classifier.submit --grain complex \
