"""Orchestrator for Stage 3 (directions → ranking → traversal).
    ...
    python -m ops_model.models.interpretability.diffex.directions.run --target HSPA5
    python -m ops_model.models.interpretability.diffex.directions.run --grain complex \
