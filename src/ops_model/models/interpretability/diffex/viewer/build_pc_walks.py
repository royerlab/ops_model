...
sd. Output: one composite figure per marker (rows = PCs, cols = α).
  ...
  python -m ops_model.models.interpretability.diffex.viewer.build_pc_walks --markers "Mitochondria_TOMM20"
  python -m ops_model.models.interpretability.diffex.viewer.build_pc_walks --all          # SLURM, every marker
"""
