...
the SAME 150px + blue negative cell-mask overlay as the PC tab (reuses build_pc_crops_masked) and emit:
  ...
  python -m ops_model.models.interpretability.diffex.viewer.build_top_cells geneKO    # SLURM crop shards + finalize
  python -m ops_model.models.interpretability.diffex.viewer.build_top_cells complex --finalize   # rebuild index only
"""
