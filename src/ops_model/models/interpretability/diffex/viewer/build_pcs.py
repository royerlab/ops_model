...
then point --html at the fresh output.
  ...
  python -m ops_model.models.interpretability.diffex.viewer.build_pcs
  python -m ops_model.models.interpretability.diffex.viewer.build_pcs --html /path/to/pc_explorer_static.html
"""
