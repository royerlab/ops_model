...
def score_shard(genes):
    import torch
    from ops_model.models.interpretability.diffex.viewer.score_generated import score_embs_v5
    from ops_model.models.interpretability.diffex.viewer.set_classifier import load_set_classifier, V5_CKPT_ROOT, V5_RUNS
