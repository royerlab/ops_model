...
def check(gene="AACS", ai=6):
    from ops_model.models.interpretability.diffex.viewer.score_generated import _emb_frames
    from ops_model.models.interpretability.diffex.classifier.celldino_features import embed_crops
