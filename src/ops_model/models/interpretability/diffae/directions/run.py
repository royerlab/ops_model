"""Orchestrator for Stage 3 (directions → ranking → traversal).
    ...
    python -m ops_model.models.interpretability.diffae.directions.run --target HSPA5
    python -m ops_model.models.interpretability.diffae.directions.run --grain complex \
