...
Source store (per reference_phenotyping_v3_store):
  ...
  python -m ops_model.models.interpretability.diffae.traversal.build_pc_crops_masked --sample 24   # preview
  python -m ops_model.models.interpretability.diffae.traversal.build_pc_crops_masked               # full (overwrites crops/)
"""
