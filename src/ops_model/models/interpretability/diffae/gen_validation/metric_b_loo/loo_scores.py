...
from ops_model.models.interpretability.diffae.gen_validation.metric_b_loo.rank_removal_test import BAGS, _gen_marg, _ipeak
...
def test_fix(gene="POLR1B", device="cuda"):
    ...
    from ops_model.models.interpretability.diffae.viewer.set_classifier import load_set_classifier, V5_CKPT_ROOT, V5_RUNS
    from ops_model.models.interpretability.diffae.gen_validation.metric_b_loo.rank_removal_test import _gen_marg
...
def run_fluor(mod, grain, device="cuda"):
    import types, torch
    from ops_model.models.interpretability.diffae.viewer.set_classifier import load_set_classifier, V5_CKPT_ROOT, V5_RUNS
    from ops_model.models.interpretability.diffae.gen_validation.centroid_recovery.f_centroid_recovery import _emb   # shared embcache
