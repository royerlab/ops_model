"""Orchestrator for the DiffEx single-cell classifier PoC.
    ...
    python -m ops_model.models.interpretability.diffae.classifier.run --model B --gene HSPA5
    python -m ops_model.models.interpretability.diffae.classifier.run --model C --gene HSPA5
