...
SAME schema as the old qualifying rankings so build_marker is a drop-in.
  ...
  python -m ops_model.models.interpretability.diffae.viewer.build_fluor_shap_rankings          # local (needs ~64GB)
  python -m ops_model.models.interpretability.diffae.viewer.build_fluor_shap_rankings --submit # SLURM cpu, mem 96
"""
