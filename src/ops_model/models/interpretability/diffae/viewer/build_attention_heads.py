...
where modality = "phase" | slugify(marker_channel), grain = geneKO|complex, key = gene | complex-slug.
  ...
  python -m ops_model.models.interpretability.diffae.viewer.build_attention_heads render            # SLURM (all trees)
  python -m ops_model.models.interpretability.diffae.viewer.build_attention_heads render --local    # serial, no SLURM
  python -m ops_model.models.interpretability.diffae.viewer.build_attention_heads render --dry-run
  python -m ops_model.models.interpretability.diffae.viewer.build_attention_heads index             # (re)aggregate index.json
"""
