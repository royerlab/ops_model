...
production pma_v5_phase_* are left in place) so we can validate before repointing GRAINS.
  ...
  python -m ops_model.models.interpretability.diffae.viewer.build_phase_shap_rankings --geneko  --submit
  python -m ops_model.models.interpretability.diffae.viewer.build_phase_shap_rankings --complex --submit
"""
