...
from ops_model.models.interpretability.diffae.viewer.morpho_pipeline import (
...
def _vs_npm3_model():
    ...
    if "m" not in _VS_MODEL:
        import torch
        from ops_model.models.interpretability.diffae.generator.config import DiffAEConfig
        from ops_model.models.interpretability.diffae.generator.model import DiffAE
...
def vsnpm3_panel(n=6, min_size=25, erode=4):
    ...
    import matplotlib.pyplot as plt
    from skimage.segmentation import find_boundaries
    from ops_model.models.interpretability.diffae.viewer.morpho_pipeline import _seg_masked_object, MO_PARAMS
    _zarr_patch()
