...
FIGURES = [
    ...
    dict(group="MTOR_lyso", dir="lysosome_LysoTracker_live_cell_dye/geneKO/MTOR",
         feature="obj_area_filled_sum", cell=0, simple="Lysosome area",
         label="mTOR (LysoTracker) · object area filled sum", out_stem="MTOR_lyso_area"),
    dict(group="MTOR_lyso_count", dir="lysosome_LysoTracker_live_cell_dye/geneKO/MTOR",
         feature="obj_area_count", cell=0, simple="Lysosome count",
         label="mTOR (LysoTracker) · object count", out_stem="MTOR_lyso_count"),
